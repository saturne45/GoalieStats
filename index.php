...
<link rel="stylesheet" href="Accueil.css" media="screen">
  ...
  <body data-home-page="Accueil.php" data-home-page-title="Accueil" class="u-body"><header class="u-clearfix u-header u-palette-5-dark-3 u-header" id="sec-bb51"><div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-border-3 u-border-grey-40 u-container-style u-group u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h4 align="center"><a href="Liste.php">Voir les parties creés</a></h4>
            <h3 class="u-align-center u-text u-text-default u-text-1">Bienvenue sur Goalie Stats<br>
              <br>Information:<br>
              <br>Savoir ​l'efficacité du gardien de but.<br>
              <br>Se site web VA être conçu dans le but de pratiquer les points forts et les points faibles d'un gardien de but de hockey<br>
              <br>
              <span class="u-text-body-alt-color">
                <span class="u-text-palette-2-base">
                  <span style="font-size: 1.25rem;"> Ps: Se n'est pas moi qui a eut l'idée de faire ça c'est mon père alias: Ombrenoir&nbsp;</span>
                  <br>
                </span>
                <span style="font-size: 1.125rem;" class="u-text-palette-2-base"> qui a eut pour idée de faire une application et non un site web. Moi je transforme son idée en site web puisque je connais pas assez la programmation pour le faire en application mobile.</span>
              </span>
              <br>
            </h3>
          </div>
...
<script type="text/javascript">
  var tableau = ['Hockey'];
  var text = prompt("Entrez un sport qui est valide")

    if(tableau.indexOf(text) != -1){
      alert("ok")
    }else{
      alert("Pas ok")
      break();
